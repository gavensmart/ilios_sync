...
SYNCED_CALENDAR_ID  = "108dda63044d8d8c56b88dfb9cb14543b8298eeaf67cb6f0b956f5ae086239f9@group.calendar.google.com"
...
def mirror_and_color():
    ...
    for evt in events:
        ...
        if "clinical skills practical" in combined_text and "prep session" in combined_text:
         color_id = COLOR_MAP["clinical skills practical prep session"]

        elif "clinical skills practical" in combined_text and "exam" in combined_text:
         color_id = COLOR_MAP["clinical skills practical"]

        elif "anatomy lab" in combined_text and "quiz" in combined_text:
            color_id = COLOR_MAP.get("quiz")
        
        elif "discussion" in combined_text and "large group" in combined_text and "Q&A" in combined_text:
            color_id = COLOR_MAP.get("discussion large")
        else:
