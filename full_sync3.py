...
SYNCED_CALENDAR_ID  = "87b7c98281b0d5fe0e709e5f4a14c8f5b3aa2bd62948dfb12cd8b1a405f4f8b0@group.calendar.google.com"
...
def mirror_and_color():
    ...
    for evt in events:
        ...
        color_id = next((cid for kw, cid in COLOR_MAP.items() if kw in combined_text), None)
        ...
        try:
            ...
            print(f"✅ Added: {evt['summary']} → color {color_id}")
            added += 1
            time.sleep(0.3)
