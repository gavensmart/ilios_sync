...
SYNCED_CALENDAR_ID  = "85179bd07b4a92264d65d97bcd2d06f6ffbb110792d2fecd6ed8f68acf4e1cd0@group.calendar.google.com"
...
def mirror_and_color():
    ...
    # Load previously mirrored event keys
    mirrored_uids = set()
    try:
    ...
    for evt in events:
        ...
        combined_text = (evt["summary"] + " " + evt["description"]).lower()

        # Match the first (longest) keyword found
        color_id = next((cid for kw, cid in sorted_keywords if kw.lower() in combined_text), None)
